...
/**
 * hinnflowAI 设计令牌。版式取值实测自 www.hinnflow.com 与 canvas.hinnflow.com：
 *   药丸 999px，卡片 20px，eyebrow 11px + 0.32em 字距，标题 500 字重 / -0.02em。
 * 主色为科技蓝 #1668FF（完整依据见 theme-css.md）。
